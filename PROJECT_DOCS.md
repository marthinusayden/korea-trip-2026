...
├── index.html          # Brochure — destination guide (97 KB)
├── itinerary.html      # Full Itinerary — day planner with drag UI (194 KB)
├── menu.html           # The Menu — food / activities / shopping hub (134 KB)
